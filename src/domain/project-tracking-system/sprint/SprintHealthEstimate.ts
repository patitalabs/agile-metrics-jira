export class SprintHealthEstimate {
  ...
  private currentEstimateIndex(): number {
  ...
  private lowerTimeBound(): number {
    ...
    const previousEstimateRatio =
      this.estimationValues[previousEstimateIndex * this.timeEstimateRatio()];
    return (
  ...
  private upperTimeBound(): number {
    ...
    const nextEstimateRatio =
      this.estimationValues[nextEstimateIndex * this.timeEstimateRatio()];
